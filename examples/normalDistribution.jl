...
# 1. fixing the marginal distributions
...
# b) using Grassberger estimator (takes approx 2 minutes)
method = GPolymatroid(false, Mosek.Optimizer(), 0.01)

ci_G_10m, ent_G_10m = connected_information(distribution_10m, collect(2:5); method)
...
normalise_and_sort_dict(ci_G_10m)
